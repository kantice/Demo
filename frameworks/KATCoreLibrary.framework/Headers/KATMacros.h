...
//block object
#define BLOCK_OBJ(o) __block typeof(o) o##Block=o;

//weak object
#define WEAK_OBJ(o) __weak typeof(o) o##Weak=o;
...
#define IS_SCREEN_HEIGHT_1194 ((MAX([UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.height)>=1193 && MAX([UIScreen mainScreen].bounds.size.width,[UIScreen mainScreen].bounds.size.height)<=1195)?YES:NO)
